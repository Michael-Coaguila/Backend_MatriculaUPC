...
('Ana Ramirez', 'ana.ramirez@upc.edu.pe', 'U135798642', '2024-03-16 11:00:00', 0, 1, 'https://e7.pngegg.com/pngimages/572/301/png-clipart-graduation-ceremony-graduate-university-square-academic-cap-computer-icons-academic-degree-school-logo-graduation-ceremony.png'),
...
VALUES 
(1, 1), (1, 2), (1, 3), (1, 4), -- Michael Coaguila (Ciclos 1-4)
(2, 5), (2, 6), (2, 7), -- Sandra Perez (Ciclos 5-6)
(3, 8), (3, 9), (3, 10), -- Luis Gutierrez (Ciclos 7-8)
(4, 11), (4, 12), (4, 13), -- Ana Ramirez (Ciclos 8-9)
(5, 14), (5, 15), (5, 16); -- Carlos Medina (Ciclos 9-10)
GO
